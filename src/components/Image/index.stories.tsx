...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://cocksam.com/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://cocksam.com/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://cocksam.com/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
